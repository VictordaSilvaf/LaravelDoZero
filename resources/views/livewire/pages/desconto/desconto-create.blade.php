    ...
    <div class="">
        ...
        <div class="">
                ...
                <form wire:submit.prevent="buscarProduto" class="font-extralight">
                    <div class="">
                        ...
                        <input type="text" id="identificacaoProduto" name="identificacaoProduto"
                            ...
                            @if (isset($identificacaoProduto)) value="{{ $produto->codigo }}" @endif />
                    </div>
            ...
            @if (isset($desconto))
                <form action={{ route('descontos.update2', ['id' => $desconto->id]) }} method="POST"
                    wire:submit.prevent='submit' class="@if (!isset($produto)) hidden @endif">
                @else
                    <form action={{ route('descontos.store') }} method="POST" wire:submit.prevent='submit'
                        class="@if (!isset($produto)) hidden @endif">
            @endif
