            ...
            <form wire:submit.prevent="register" enctype="multipart/form-data">
                ...
                @if ($avatar)
                    <div class="flex justify-center w-full mt-3">
                        <img src="{{ $avatar->temporaryUrl() }}" class="w-40 h-40 rounded-full">
                    </div>
                    <div class="mt-3">
                @else
                    <div class="mt-6">
                ...
                @endif
                    ...
                    <div class="mt-1 rounded-md shadow-sm">
                        <input wire:model.lazy="avatar" id="avatar" type="file" required class="appearance-none block w-full px-3 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:ring-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5 
                        @error('avatar') border-red-300 text-red-900 placeholder-red-300 focus:border-red-300 focus:ring-red @enderror" />
                    </div>
